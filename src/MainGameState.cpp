...
void MainGameState::handleInput(){
    ...
    if (turno =='2'){
        ...
        //ya no pillamos mas info del jugador 1
        if(IsKeyPressed(KEY_ENTER)){
            turno='r';
        }
    }
...
void MainGameState::render(){
    ...
    //Turno
    DrawText("Turno "+contador_turno,screenWidth/2 -15,screenHeight/2,24,PURPLE);
    DrawText("Turno de "+turno,screenWidth/2 -15,screenHeight/2,24,PURPLE);
    // Suelo
    ...
    if (turno=='r')
        DrawCircleV(projectile_1.pos, 5, BLACK);
        DrawCircleV(projectile_2.pos, 5, BLACK);
